...
SASE_DIR = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
...
# SECRET_KEY = 'django-insecure-=p)cjsto%m4#bc#=sd87ka@08uxm5e^@pl-yrb-3$m+@d!z^_+'
